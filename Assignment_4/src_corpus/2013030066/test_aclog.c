...
int main() 
{
	...
	for (i=0;i<9;i++){ //
		...
		file = fopen("tst2", "r"); //this version of test_aclog is different to what created the log. tst2 (in the log, tst0-tst8) is a file with all rights disabled for everyone
		if (file == NULL){
